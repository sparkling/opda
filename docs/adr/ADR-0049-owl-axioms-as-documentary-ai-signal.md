...
10. **Positive doctrine ODR** — consolidate ODR-0025 §R2 / 0026 §R2 / 0027 §R5 (fix its "hm ODR-0014" ref) / 0029 §R1 into one; **strip ALL `hm`/`semantic-modelling` references from normative text** (cite as prior art in §More Information only).
