...
* **Scheduling + scope:** Council [session-031](../ontology/odr/council/session-031-schema-accommodation-scope-and-trigger-resolution.md) (schema-accommodation scope — this is the one held item that is pure-additive and sound, hence DONE-NOW); [ODR-0023](../ontology/odr/ODR-0023-descriptive-layer-follow-on-council-roadmap.md) R2 (conjunct (i) of the re-open trigger).
