...
breadcrumb ancestors render no breadcrumb region and remove the article's duplicate upper inset. The mini organisation lock-up uses an eight-pixel lower margin to reduce the empty space above it without moving the framework heading, navigation row or divider.
