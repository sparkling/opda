...
breadcrumb ancestors render no breadcrumb region and remove the article's duplicate upper inset. The desktop masthead is 144px high: an eight-pixel negative lower margin keeps the mini organisation lock-up fixed while the framework heading, navigation row, divider and page shell move upward by a further four pixels.
