...
Adopt the Q3 2026 guide and supplied vectors for this application and complete them through the derived OPDA web system specified in `DESIGN.md`. On 6 September 2026 the operator adopted **OPDA editorial watercolour** after approving seven subject-specific light/dark pairs. On 10 September 2026 that medium became one option in a governed, subject-led illustration family: briefs choose deliberately among watercolour/gouache, architectural cutaway or ink-and-coloured-pencil, short sequential ink narrative, risograph/screenprint, paper craft or another justified form. Each placement requires its own learning or promotion purpose, concrete subject/action and unique concept/composition; no image is reused across pages, cards or sections. A light/dark pair and resolution renditions are one asset family. `DESIGN.md` and `/design-system` define the current briefing, pairing, palette, accessibility and preservation rules; the approved set-3 specimens and prompts remain historical records. Illustration remains excluded from identity, evidence and exact technical diagrams. This amendment does not change the supplied brand assets or photography-rights gate.
...
above content headings with no horizontal divider; the page H1 remains unchanged, with restored nested paragraph gaps and hanging list
