...
breadcrumb ancestors render no breadcrumb region and remove the article's duplicate upper inset. The desktop masthead is 136px high: a 16px negative lower margin keeps the mini organisation lock-up fixed while the framework heading, navigation row, divider and page shell move upward by a further eight pixels.
