...
- Adopted prior art (hm `~/source/hm/semantic-modelling/docs/ontology/odr/`): hm ODR-0010 (multi-faceted classification; the 13 Role-as-subclass fixes), hm ODR-0014 (domain/range as documentation), hm ODR-0016 (SKOS for enumerations), hm ODR-0023 (enumeration modelling pattern), hm ODR-0025 (role-view modelling), hm ODR-0026 (property distribution / role-borne properties), hm ODR-0092 (UFO stereotypes as SKOS schemes).
