...
**State at top of programme (2026-05-27).** All 14 original Council sessions ratified + Phase-3.5 audit + Session 003c WG housekeeping. 17 ODRs accepted (0001 thru 0018 minus 0014 superseded + 0016 deferred-until-trigger). Namespace ratified at `https://w3id.org/opda/#` (Session 003b + ADR-0006). Generator specification ratified ([ADR-0007](../adr/ADR-0007-ontology-generator-specification.md)).
...
|---|---|---|---|---|
| Phase 1 — Bootstrap | [ADR-0008](../adr/ADR-0008-generator-implementation-infrastructure.md) | Generator implementation infrastructure | ODR-0004 §6a; ADR-0007 | (none — bootstrap) |
| Phase 1 — Bootstrap | [ADR-0009](../adr/ADR-0009-foundation-ttl-emission.md) | Foundation TTL emission | ODR-0004 §3a, §6a; ODR-0001 §What-an-ODR-records | ADR-0008 |
| Phase 2 — Substrate | [ADR-0010](../adr/ADR-0010-skos-vocabulary-emission.md) | SKOS vocabulary emission | ODR-0011; A9 per-kind discipline | ADR-0009 |
| Phase 3 — Modules | [ADR-0011](../adr/ADR-0011-module-tbox-emission.md) | Module TBox emission (Property + Agent + Transaction + Claims + Address + Descriptive Attributes) | ODR-0005 + ODR-0006 + ODR-0007 + ODR-0008 + ODR-0009 + ODR-0015 + ODR-0017 + ODR-0018 | ADR-0009 + ADR-0010 |
| Phase 4 — Validation | [ADR-0012](../adr/ADR-0012-shacl-and-dpv-annotation-emission.md) | SHACL shapes + DPV annotation emission | ODR-0010 §Q1-Q6; ODR-0012; ODR-0013; ODR-0017; ODR-0018 | ADR-0011 |
| Phase 5 — Overlays | [ADR-0013](../adr/ADR-0013-overlay-profile-emission.md) | Overlay profile emission | ODR-0010 (full); three-rule interface contract | ADR-0012 |
| Phase 6 — MVP | [ADR-0014](../adr/ADR-0014-baspi5-round-trip-mvp-harness.md) | BASPI5 round-trip MVP harness + diagnostic exemplar regression | ODR-0010 §Q7 (MVP gate); ODR-0004 §8a; ODR-0003 §Programme retirement criterion | ADR-0013 |
...
Per [ADR-0007 §"Byte-identity CI test"](../adr/ADR-0007-ontology-generator-specification.md), `.github/workflows/ontology-byte-identity.yml` runs on every push + PR. Tests:
...
- **Sister plan:** [Council follow-up sessions](./council-followup-sessions.md). The Council ratification programme that produced the inputs (ODR `## Rules`) this plan consumes.
- **Foundation ADR:** [ADR-0006 — Ontology namespace at w3id.org/opda/ via W3C PICG redirect](../adr/ADR-0006-w3id-opda-ontology-namespace.md). Phase 0 infrastructure.
- **Specification ADR:** [ADR-0007 — Ontology generator specification](../adr/ADR-0007-ontology-generator-specification.md). Specifies what ADR-0008 implements.
