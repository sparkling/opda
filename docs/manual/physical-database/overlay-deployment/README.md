...
Overlay profiles are per-form SHACL profile graphs that compose over the foundation + module TBox + base shapes per [ODR-0010](../../../ontology/odr/). Each overlay (BASPI5, TA6, NTS, LPE1, CON29R, etc.) defines per-form cardinality, enum subsets, and DASH UI rendering. The MVP gate per [ADR-0014](../../../adr/ADR-0014-baspi5-round-trip-mvp-harness.md) targets **BASPI5 only**; other overlays follow once the BASPI5 round-trip pattern is proven.

## Overlay catalogue

| Overlay | Status | Source profile TTL | Round-trip harness | ADR |
|---|---|---|---|---|
| [BASPI5](./baspi5.md) | deployed (MVP gate) | `source/03-standards/ontology/profiles/baspi5.ttl` | `tests/baspi5_round_trip/` | [ADR-0013](../../../adr/ADR-0013-overlay-profile-emission.md) + [ADR-0014](../../../adr/ADR-0014-baspi5-round-trip-mvp-harness.md) |
| TA6 | not yet emitted | pending | pending | [ADR-0013](../../../adr/ADR-0013-overlay-profile-emission.md) §"Overlay catalogue (initial)" Phase 2 |
...
The three-rule interface contract ([ADR-0013](../../../adr/ADR-0013-overlay-profile-emission.md)) governs every overlay:
...
- [ADR-0013 — Overlay profile emission](../../../adr/ADR-0013-overlay-profile-emission.md) — per-overlay emission template + three-rule interface contract.
- [ADR-0014 — BASPI5 round-trip MVP harness](../../../adr/ADR-0014-baspi5-round-trip-mvp-harness.md) — three-layer harness that gates MVP closure.
