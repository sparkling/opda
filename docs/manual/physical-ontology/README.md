...
- [ADR-0007 — Ontology generator specification](/modelling/adr/adr-0007)
- [ADR-0008 — Generator implementation infrastructure](/modelling/adr/adr-0008)
...
- [ODR-0017 — SHACL-AF quality rules pattern](/modelling/odr/odr-0017) (11 citing sites)
