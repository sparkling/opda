...
- [Data dictionary](/development/inputs/pdtf-schema/schema-and-supporting-material/data-dictionary) — the schema-level element register in the PDTF schema supporting material.
