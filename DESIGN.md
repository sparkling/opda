...
- **Header action:** one shared outlined secondary button may sit at the utility end of the
  application header; it uses a short verb-led label, aligns to the content-right edge and sits eight pixels above through normal layout margin rather than a visual offset,
