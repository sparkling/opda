...
The desktop header is 148px, `#131224`, and has three rows: a linked mini “Open Property Data Association”
...
shell. The mini title lock-up consumes the shared relative icon, gap, alignment and colour contract. The shorter desktop masthead and a four-pixel lower margin on the mini lock-up move the framework heading, navigation row, divider and page shell upward while retaining the mini lock-up's established position.
