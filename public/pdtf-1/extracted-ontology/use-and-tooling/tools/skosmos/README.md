...
Fuseki/GRLC stack (`make serve-data`), and the PDTF 1.0 extracted ontology **links out**
...
The extracted ontology's controlled-vocabularies page links to `http://localhost:9090/` with a note
