# custom `opda-gen` — the composed PDTF 1.0 extracted-ontology reference
...
`tools/custom/`. It is the **woven extracted-ontology section itself** — the
...
LLM prose must supply. The custom output is woven into the extracted-ontology
