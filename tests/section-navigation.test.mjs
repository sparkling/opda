...
test('the left section navigation implements all seven destinations from one registry', () => {
  ...
  for (const required of [
    ...
    '/resources', '/glossary',
    '/marketing', '/marketing/invite-someone', '/marketing/share-with-members', '/marketing/packs',
...
test('category landing pages remain in breadcrumbs and exact page sequences', () => {
  for (const [sectionKey, heading, category, firstChild] of [
    ...
    ['marketing', 'By audience', '/marketing/packs', '/marketing/packs/general'],
    ['marketing', 'By broadcaster', '/marketing/broadcasters', '/marketing/broadcasters/opda'],
