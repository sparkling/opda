...
class SchemaReproducibilityTests(unittest.TestCase):
    def test_schema_generator_uses_the_hierarchical_route_and_source_root(self):
        self.assertEqual(
            ...
            "/development/inputs/pdtf-schema/schema-and-supporting-material/schema",
        )
        self.assertEqual(
            generator.OUT_PAGES,
            ROOT / "src/pages/development/inputs/pdtf-schema/schema-and-supporting-material/schema",
        )
        self.assertEqual(
            generator.page_url("38b"),
            "/development/inputs/pdtf-schema/schema-and-supporting-material/schema/legal-estate/title/oc-summary",
        )
    ...
    def test_generated_page_coverage_includes_nested_schema_paths_only(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            nested = (
                root
                / "src/pages/development/inputs/pdtf-schema/schema-and-supporting-material/schema/legal-estate/title/page.astro"
            )
    ...
    def test_dama_mapping_has_no_retired_pdtf_documentation_roots(self):
        ...
        schema_page = (
            "src/pages/development/inputs/pdtf-schema/schema-and-supporting-material/schema/"
