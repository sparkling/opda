...
test('shared navigation exposes visible focus, state and 44px targets', async () => {
  ...
  assert.match(base, /\.app-header__framework\s*\{[^}]*margin-block-end:\s*calc\(-1 \* var\(--space-3\)\)[^}]*padding:\s*var\(--space-4\) 0 0[^}]*font:\s*500 var\(--text-2xl\)[^}]*text-decoration:\s*none/su);
