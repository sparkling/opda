 ...
 *
 * Emits:
 *   public/pdtf-1/extracted-ontology/use-and-tooling/tools/custom/index.html
 *   public/pdtf-1/extracted-ontology/use-and-tooling/artefacts/source/index.html
 *
...
const PUBLIC_ONTOLOGY = path.join(
  ROOT,
  'public/pdtf-1/extracted-ontology/use-and-tooling',
);
...
narrative hand/LLM-authored. Regenerate after any ontology change. Part of the ADR-0041 PDTF 1.0 extracted-ontology composition.</footer>
</body></html>`;
