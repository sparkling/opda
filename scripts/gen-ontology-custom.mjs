 ...
 *
 * Emits:
 *   public/development/inputs/pdtf-schema/schema-derived-ontology/use-and-tooling/tools/custom/index.html
 *   public/development/inputs/pdtf-schema/schema-derived-ontology/use-and-tooling/artefacts/source/index.html
 *
...
const PUBLIC_ONTOLOGY = path.join(
  ROOT,
  'public/development/inputs/pdtf-schema/schema-derived-ontology/use-and-tooling',
);
...
// Output is byte-deterministic (no wall-clock) so the doc-drift gate can compare
// regenerated-vs-committed. Provenance/dates live in git, not in the artefact.
...
provenance is the ODR/ADR/council corpus: the schema-to-ontology project is <strong>retired</strong> (ODR-0003, 2026-06-14);
the descriptive layer is reconciled complete (ODR-0028); the inference/validation boundary is ODR-0029 (Council
session-039); this reference document is ADR-0041 (Council session-038), and ADR-0042 records the historical
<code>/manual</code>→<code>/model</code> rename. Both former documentation routes are now retired.</p>

<h2>6 · Known-issues register</h2>
<table><thead><tr><th>Issue</th><th>Record</th><th>Status</th><th>Detail</th></tr></thead>
<tbody>${issueRows}</tbody></table>

<footer>Generated by <code>scripts/gen-ontology-custom.mjs</code> from the committed TTL corpus;
narrative hand/LLM-authored. Regenerate after any ontology change. Part of the ADR-0041 schema-derived ontology composition.</footer>
</body></html>`;
...
<footer>Generated by <code>scripts/gen-ontology-custom.mjs</code>.</footer></body></html>`;
