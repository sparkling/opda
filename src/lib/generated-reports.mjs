...
export const IA_LINK_MAP = {
  'README.md':               '/spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/information-architecture/overview',
  'concept-model-ia.md':     '/spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/information-architecture/concept-model',
  'logical-model-ia.md':     '/spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/information-architecture/logical-model',
  'physical-database-ia.md': '/spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/information-architecture/physical-database',
  'physical-ontology-ia.md': '/spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/information-architecture/physical-ontology',
};
