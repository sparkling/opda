/**
 * Leaf-path -> {url, anchor} lookup over the committed /spdtf/inputs/pdtf-schema/schema-and-supporting-material/schema/*.astro pages
 ...
 *
 * The /spdtf/inputs/pdtf-schema/schema-and-supporting-material/schema pages themselves are generated (scripts/build-schema-pages.py)
...
const SCHEMA_ROUTE = '/spdtf/inputs/pdtf-schema/schema-and-supporting-material/schema';
const SCHEMA_DIR = path.resolve(process.cwd(), 'src/pages/spdtf/inputs/pdtf-schema/schema-and-supporting-material/schema');
