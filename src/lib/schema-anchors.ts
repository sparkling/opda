/**
 * Leaf-path -> {url, anchor} lookup over the committed /development/inputs/pdtf-schema/schema-and-supporting-material/schema/*.astro pages
 ...
 *
 * The /development/inputs/pdtf-schema/schema-and-supporting-material/schema pages themselves are generated (scripts/build-schema-pages.py)
...
const SCHEMA_ROUTE = '/development/inputs/pdtf-schema/schema-and-supporting-material/schema';
const SCHEMA_DIR = path.resolve(process.cwd(), 'src/pages/development/inputs/pdtf-schema/schema-and-supporting-material/schema');
