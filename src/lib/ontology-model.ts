...
/** The /spdtf/inputs/pdtf-schema/schema-derived-ontology/concepts-and-architecture/contexts page URL for a module, or null if it isn't one of the 7. */
export const contextUrl = (m: string | null | undefined): string | null =>
  (isContext(m) ? `/spdtf/inputs/pdtf-schema/schema-derived-ontology/concepts-and-architecture/contexts/${m}` : null);
 ...
 * minted opda: term IRIs, so they live at /spdtf/inputs/pdtf-schema/schema-derived-ontology/concepts-and-architecture/contexts/{id}.)
 */
