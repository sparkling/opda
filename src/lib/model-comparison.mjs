...
const evidence = {
  current: { label: 'Schema-derived ontology reference', href: '/development/inputs/pdtf-schema/schema-derived-ontology' },
  currentProvenance: { label: 'Schema-derived ontology provenance', href: '/development/inputs/pdtf-schema/schema-derived-ontology/lineage-provenance-and-verification/decision-provenance' },
  currentSchema: { label: 'PDTF schema reference', href: '/development/inputs/pdtf-schema/schema-and-supporting-material/schema' },
  currentMapping: { label: 'Schema-to-ontology RML mapping', href: '/development/inputs/pdtf-schema/schema-derived-ontology/lineage-provenance-and-verification/schema-to-ontology-verification' },
  currentProfiles: { label: 'Schema-derived overlay profiles', href: '/development/inputs/pdtf-schema/schema-derived-ontology/validation-and-examples/profiles' },
  v2Overview: { label: 'Property Pack candidate overview', href: '/development/property-pack' },
  v2Contexts: { label: 'Property Pack contextual boundaries', href: '/development/property-pack/contexts' },
  v2Coverage: { label: 'Property Pack source coverage', href: '/development/property-pack/coverage' },
  v2Resources: { label: 'Property Pack ontology resources', href: '/development/property-pack/resources' },
  v2Shapes: { label: 'Property Pack SHACL shapes', href: '/development/property-pack/shapes' },
  v2Vocabularies: { label: 'Property Pack controlled vocabularies', href: '/development/property-pack/vocabularies' },
  v2Standards: { label: 'Property Pack standards profile', href: '/development/property-pack/standards' },
  v2Validation: { label: 'Property Pack validation evidence', href: '/development/property-pack/validation' },
