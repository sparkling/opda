...
export const SITE_SEARCH_ENTRIES = Object.freeze([
  ...
  entry('Join a working group', '/spdtf/working-groups/join', 'Register an expression of interest in contributing domain knowledge to SPDTF working groups', ['participation', 'register', 'sign up']),
  entry('Working-group privacy notice', '/spdtf/working-groups/join/privacy', 'How OPDA uses personal information supplied through the working-group expression-of-interest form', ['privacy', 'registration']),
