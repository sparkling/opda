...
export const SITE_SEARCH_ENTRIES = Object.freeze([
  ...
  entry('Six-part semantic package', '/spdtf-2/ontologies/semantic-package', 'Glossary, dictionary, taxonomies, vocabularies, resources and relationships', ['PDTF', 'ontology']),
  entry('Contexts and common boundary', '/spdtf-2/ontologies/bounded-contexts', 'Semantic homes, context ownership, interoperability and the Property Pack profile', ['ontology']),
  entry('Modelling rules and lenses', '/spdtf-2/ontologies/modelling-rules', 'Identity, classes, values, relationships, reuse and candidate upper-ontology methods', ['ontology']),
  ...
  entry('Standards profile', '/spdtf-2/ontologies/standards', 'Actual implementation, specification maturity, targets, candidates and deferred options', ['PDTF', 'ontology']),
