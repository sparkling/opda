...
export const SITE_SEARCH_ENTRIES = Object.freeze([
  ...
  entry('Modelling', '/semantic-modelling', 'Understand, explore, contribute and study technical ontology modelling through one connected property case', ['ontology', 'ontologies and semantic modelling', 'SPDTF', 'linked data']),
  ...
  entry('Technical ontology modelling', '/semantic-modelling/method', 'The context-first ontology-modelling method, grounded in evidence, explicit identity, reusable standards and accountable human review', ['ontology', 'method', 'manifesto', 'principles', 'bottom up', 'domain driven design', 'how we model SPDTF']),
