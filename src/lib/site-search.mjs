...
export const SITE_SEARCH_ENTRIES = Object.freeze([
  ...
  entry('Ontologies and semantic modelling', '/spdtf-2/ontologies', 'Choose a plain-language ontology guide or the SPDTF 2.0 implementation documentation', ['PDTF', 'ontology', 'semantic modelling', 'RDF', 'OWL', 'SKOS', 'SHACL', 'SPARQL', 'upper ontology']),
