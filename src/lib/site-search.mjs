...
export const SITE_SEARCH_ENTRIES = Object.freeze([
  ...
  entry('Modelling', '/semantic-modelling', 'Understand, explore, contribute and apply the method through one connected property case', ['ontology', 'ontologies and semantic modelling', 'SPDTF', 'linked data']),
  ...
  entry('Apply the modelling method', '/semantic-modelling/method', 'A context-first approach grounded in evidence, explicit identity, reusable standards and accountable human review', ['ontology', 'method', 'manifesto', 'principles', 'bottom up', 'domain driven design', 'how we model SPDTF']),
  ...
  entry('Eight concerns, six connected outputs', '/semantic-modelling/method/scope-and-package', 'Apply the selected modelling concerns and coordinate glossary, dictionary, taxonomies, vocabularies, resources and relationships', ['ontology', 'ODR-0071', 'ODR-071', 'coverage checklist', 'semantic package', 'scope', 'six outputs']),
  ...
  entry('Standards and decisions', '/semantic-modelling/method/standards-and-decisions', 'Trace selected source-method rules, OPDA adoption scope, illustrative examples and actual candidate implementation separately', ['ontology', 'ODR-0071', 'ADR', 'ODR', 'decision basis', 'source contract', 'normative', 'candidate status']),
