...
export const SITE_SEARCH_ENTRIES = Object.freeze([
  ...
  entry("Understand shared meaning", '/semantic-modelling/understand', "Why this matters, what we are building and how your practical knowledge can improve it. Start with a question from property work, not ontology code.", ['ontology', 'beginner', 'nontechnical', 'FAQ', 'common questions']),
  entry("Why shared meaning matters", '/semantic-modelling/understand/shared-meaning', "Correctly formatted information can still answer the wrong question. Learn to read the subjects and connections that make an account understandable.", ['ontology', 'benefits', 'business case', 'semantic interoperability', 'why ontologies']),
  entry("What we are building", '/semantic-modelling/understand/what-we-are-building', "An agreement you can inspect in six useful ways: meanings, data descriptions, topics, choices, resources and relationships.", ['ontology', 'field guide', 'worked example']),
  entry("Benefits, limits and reasonable objections", '/semantic-modelling/understand/benefits-and-limits', "Shared meaning is worth the effort when it preserves distinctions people need. Examine the benefit, the conditions and the work that remains.", ['ontology', 'field guide', 'worked example']),
  entry("Harbour Court: follow a question through the model", '/semantic-modelling/understand/a-property-story', "An inspection, a corrected report and a proposed sale. Follow the evidence without confusing the building, its dwellings or their descriptions.", ['ontology', 'Harbour Court', 'worked example', 'survey date', 'how to read the model']),
  entry("How the modelling work is done", '/semantic-modelling/understand/how-the-work-is-done', "Practical questions and authorised evidence become a proposal people can read, test and challenge. You can contribute before that proposal exists.", ['ontology', 'field guide', 'worked example']),
  entry("Explore the model", '/semantic-modelling/explore', "Learn the distinctions that make property information usable: which subject, role, quantity, time, claim or meaning are we actually describing? Start with the question on your desk.", ['ontology', 'concepts', 'model diagram', 'resources', 'relationships']),
  entry("Things, identities and relationships", '/semantic-modelling/explore/things-and-identities', "Before joining information, establish what each statement describes. Then read every connection as a claim you could explain—and challenge—in an ordinary sentence.", ['ontology', 'identity', 'building', 'dwelling', 'address', 'title', 'sameAs', 'subdivision']),
  entry("People, roles and change", '/semantic-modelling/explore/people-roles-and-change', "A person can participate in several arrangements without becoming several people. A changed status or corrected document also needs a subject: what changed, in which setting, and what continued?", ['ontology', 'field guide', 'worked example']),
  entry("Measurements, amounts and values", '/semantic-modelling/explore/measurements-amounts-and-values', "Two numbers may disagree because they answer different questions. Identify the subject, unit and stated basis before deciding whether values can be compared.", ['ontology', 'field guide', 'worked example']),
  entry("Dates, periods and applicability", '/semantic-modelling/explore/dates-periods-and-applicability', "A date is useful when we know what it dates. Separate when something happened, when an account was issued, when it was recorded and when a statement is meant to apply.", ['ontology', 'field guide', 'worked example']),
  entry("Claims, evidence and uncertainty", '/semantic-modelling/explore/claims-evidence-and-uncertainty', "Keep what a source says separate from what you conclude. A good model makes support, disagreement and missing knowledge visible without pretending that a well-described claim must be true.", ['ontology', 'field guide', 'worked example']),
  entry("Names, choices and classification", '/semantic-modelling/explore/names-and-choices', "A shared vocabulary does more than standardise spelling. It explains what a term means, which choices belong together and what an organising hierarchy does—and does not—claim.", ['ontology', 'SKOS', 'taxonomy', 'taxonomies', 'controlled vocabulary', 'enumeration', 'classification']),
  entry("Connect meanings across contexts", '/semantic-modelling/explore/contexts-and-connections', "An exchange succeeds when the recipient understands the relevant meaning. Give definitions an accountable home and inspect exactly what a proposed correspondence preserves, loses or invents.", ['ontology', 'bounded context', 'bounded contexts', 'context map', 'semantic home', 'common boundary', 'DDD']),
  entry("Rules, requirements and exceptions", '/semantic-modelling/explore/rules-and-exceptions', "A useful requirement says what it asks for, when it applies and what would demonstrate a problem. Test the meaning with ordinary and difficult cases before treating a check as an answer.", ['ontology', 'field guide', 'worked example']),
  entry("Sensitivity, purpose and permissions", '/semantic-modelling/explore/sensitivity-purpose-permissions', "A model can describe who participates, why information is used and what a permission covers. Those distinctions matter—but describing them does not authenticate anyone or grant access.", ['ontology', 'field guide', 'worked example']),
  entry("Review and contribute", '/semantic-modelling/contribute', "Bring a question before a model exists, examine a candidate now, or challenge one definition, connection, choice or rule. Your knowledge of property work is modelling input.", ['ontology', 'participation', 'nontechnical', 'feedback', 'review', 'take part']),
  entry("Turn experience into a modelling question", '/semantic-modelling/contribute/frame-a-modelling-question', "Start with a decision, misunderstanding or exception. Show what the model must help someone distinguish, before proposing a field or a software feature.", ['ontology', 'field guide', 'worked example']),
  entry("Review a definition", '/semantic-modelling/contribute/review-a-definition', "Test what a definition includes, excludes and leaves ambiguous. Compare plausible revisions, then use an ordinary case and a counterexample to explain what should change.", ['ontology', 'counterexample', 'definition review', 'feedback', 'survey date']),
  entry("Review a diagram and its relationships", '/semantic-modelling/contribute/review-diagrams-and-relationships', "Read every connection as a claim. Find a missing subject, an unjustified identity or a relationship that needs its setting, then explain the practical correction.", ['ontology', 'field guide', 'worked example']),
  entry("Review choices and mappings", '/semantic-modelling/contribute/review-vocabularies-and-mappings', "Test a choice list against its intended scope, then compare meanings across two versions and contexts. A matching label is a starting question, not evidence of equivalence.", ['ontology', 'field guide', 'worked example']),
  entry("Test a rule with ordinary and difficult cases", '/semantic-modelling/contribute/review-rules-and-exceptions', "Use small, explicit cases to establish when a requirement applies, what meets it and where the problem lies. Missing evidence is not automatically success or failure.", ['ontology', 'field guide', 'worked example']),
  entry("Bring evidence others can interpret", '/semantic-modelling/contribute/bring-evidence', "Show the relevant passage, source version, intended use and limits. Keep source wording, your interpretation and a proposed model change distinguishable, especially when material is restricted.", ['ontology', 'source material', 'evidence', 'provenance', 'SharePoint', 'privacy']),
  entry("Read a candidate and compare a change", '/semantic-modelling/contribute/read-and-compare-a-candidate', "Start directly with a real Property Pack resource page. Then use a separate fictional revision to see how a change affects several views of one agreement.", ['ontology', 'field guide', 'worked example']),
  entry("Follow feedback, disagreement and revision", '/semantic-modelling/contribute/what-happens-next', "Recognise a reasoned response: the evidence considered, meaning changed, checks made and questions left open. A retained distinction can be a successful outcome.", ['ontology', 'review outcome', 'disposition', 'approval', 'feedback', 'working group']),
  ...
  entry('Foundations and modelling judgement', '/semantic-modelling/method/foundational-analysis', 'Analyse identity, rigidity, dependence and unity without importing an upper-ontology hierarchy', ['ontology', 'OntoClean', 'UFO', 'foundational ontology', 'four axes', 'unity', 'existential dependence', 'ODR-0061']),
  entry('Choose the right representation', '/semantic-modelling/method/classes-and-relationships', 'Distinguish classes, concepts, attributes, qualified relationships and material relators through concrete counterexamples', ['ontology', 'modelling rules', 'design patterns', 'isA', 'relator', 'part whole', 'qualified relationship']),
  entry('Identity through roles and change', '/semantic-modelling/method/roles-and-phases', 'Distinguish kinds, roles and phases through identity, dependence, rigidity and concrete property counterexamples', ['ontology', 'roleOf', 'phaseOf', 'OntoClean', 'UFO', 'gUFO', 'identity']),
  entry('Vocabularies and classification', '/semantic-modelling/method/vocabularies-and-classification', 'Choose between closed values, open populations, concept hierarchies and model-classification facets; apply the right completeness profile', ['ontology', 'SKOS', 'SHACL', 'sh:in', 'controlled vocabulary', 'enumeration', 'taxonomy', 'classification', 'facet', 'completeness']),
  entry('Connect meanings across contexts', '/semantic-modelling/method/context-map-records', 'Work within established contexts and record strategic relationships separately from qualified term correspondences', ['ontology', 'DDD', 'context map', 'anti corruption layer', 'shared kernel', 'published language']),
  ...
  entry('Evidence, claims and time', '/semantic-modelling/method/evidence-and-time', 'Distinguish inspection occurrence, report versions, claim validity and provenance without treating evidence as proof', ['ontology', 'PROV-O', 'OWL-Time', 'provenance', 'valid time', 'recording time', 'report revision']),
  entry('From source evidence to model decisions', '/semantic-modelling/method/source-to-model', 'Challenge forms and schemas as evidence; build a modelling argument without copying their structure or importing a source-transformation model', ['ontology', 'source evidence', 'first principles', 'schema derived', 'source to model', 'requirements coverage', 'counterexample']),
  ...
  entry('Languages and profiles', '/semantic-modelling/method/languages-and-profiles', 'Use RDF 1.2, SPARQL 1.2 and SHACL 1.2 through bounded profiles with explicit implementation evidence', ['ontology', 'RDF', 'RDF 1.2', 'RDFS', 'OWL', 'SKOS', 'SHACL', 'SHACL 1.2', 'SPARQL', 'SPARQL 1.2', 'standards profile', 'upper ontology']),
  entry('Namespaces and identifiers', '/semantic-modelling/method/namespaces-and-identifiers', 'Understand the OPDA namespace scheme: context vocabularies, shared meaning, instance identities and stable logical IRIs', ['ontology', 'namespace', 'prefix', 'IRI', 'URI', 'opda.org.uk', 'VANN', 'identifier', 'ns', 'ODR-0065']),
