...
export const SITE_SEARCH_ENTRIES = Object.freeze([
  ...
  entry('Why shared meaning matters', '/semantic-modelling/benefits', 'Practical benefits of context-led property modelling: reuse, traceability, clearer exchange and fewer hidden differences', ['ontology', 'benefits', 'business case', 'semantic interoperability']),
  entry('Take part through the website', '/semantic-modelling/taking-part', 'Contribute professional knowledge through definitions, diagrams, examples and working-group discussion without learning ontology code', ['ontology', 'nontechnical', 'participation', 'feedback', 'review']),
  entry('Common questions about modelling', '/semantic-modelling/questions', 'Answers about participation, existing systems, shared databases, privacy, AI and model accuracy', ['ontology', 'FAQ', 'questions', 'nontechnical']),
  entry('Our modelling manifesto', '/semantic-modelling/principles', 'The normative context-first approach: practitioner language, local authority, explicit identity and connected models', ['ontology', 'manifesto', 'principles', 'bottom up', 'domain driven design']),
  entry('Context maps and semantic bridges', '/semantic-modelling/context-maps', 'Strategic DDD relationships, context authority, semantic bridges, common boundaries and term correspondences', ['ontology', 'context map', 'DDD', 'anti corruption layer', 'shared kernel', 'published language']),
  entry('Identity, roles and phases', '/semantic-modelling/identity-roles-and-phases', 'Distinguish kinds, subkinds, classification, roles, phases, identity, rigidity, dependence and relators', ['ontology', 'isA', 'roleOf', 'phaseOf', 'OntoClean', 'UFO']),
  entry('Practical modelling patterns', '/semantic-modelling/modelling-patterns', 'Property examples of participation, part-whole relationships, values, claims, evidence, time and controlled vocabularies', ['ontology', 'design patterns', 'relator', 'provenance', 'SKOS', 'SHACL']),
  entry('Languages for linked data and rules', '/semantic-modelling/linked-data-languages', 'Why RDF, RDFS, OWL, SKOS, SHACL, SPARQL and concern-specific vocabularies have different jobs', ['ontology', 'RDF', 'OWL', 'SKOS', 'SHACL', 'PROV-O', 'OWL-Time', 'domainIncludes']),
  entry('The decisions behind our modelling approach', '/semantic-modelling/decision-basis', 'Normative ODR-0071 categories, supporting source decisions, OPDA ADRs and reconciliation with the legacy PDTF explainer', ['ontology', 'ODR-0071', 'ODR-071', 'ADR', 'modelling rules', 'normative']),
  ...
  entry('Modelling rules and lenses', '/semantic-modelling/modelling-rules', 'Normative identity, classification, roles, relationships, reuse and foundational analysis without upper-ontology inheritance', ['ontology', 'upper ontology', 'UFO', 'gUFO', 'OntoClean']),
  entry('What we model', '/semantic-modelling/coverage', 'Eight selected ODR-0071 categories, their scope and exclusions, six outputs and four coverage dispositions', ['PDTF', 'ontology', 'ODR-0071', 'coverage checklist']),
  ...
  entry('Evidence and qualified mappings', '/semantic-modelling/evidence-and-mappings', 'Competency questions, provenance, Category 8 SKOS correspondences and normative SSSOM/SEMAPV mapping records', ['ontology', 'ontology mapping', 'cross-context mapping', 'cross-domain mapping', 'SKOS mapping', 'SSSOM', 'SEMAPV', 'Category 8']),
