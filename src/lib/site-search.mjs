...
export const SITE_SEARCH_ENTRIES = Object.freeze([
  ...
  entry('Model views by audience', '/model', 'PDTF 1.0-derived concept, logical, ontology, deployment and relational presentations', ['PDTF', 'derived model'], true),
  entry('PDTF 1.0-derived ontology', '/ontology', 'Draft semantic corpus derived from PDTF 1.0 evidence', ['PDTF'], true),
  entry('Lineage, provenance and verification', '/ontology/lineage-and-verification', 'How the PDTF 1.0-derived ontology was modelled, traced and checked against the schema', ['PDTF', 'RML', 'provenance'], true),
  entry('Concepts and architecture', '/ontology/concepts-and-architecture', 'Identity, semantic contexts, foundations and modelling frameworks in the PDTF 1.0-derived ontology', ['PDTF', 'ontology contexts'], true),
  entry('PDTF 1.0-derived ontology contexts', '/ontology/contexts', 'Context modules in the draft ontology extracted from PDTF 1.0 evidence', ['PDTF', 'bounded contexts'], true),
  entry('Terms and model resources', '/ontology/terms-and-model-resources', 'Classes, properties, datatypes, vocabularies and the generated term reference', ['PDTF', 'ontology terms'], true),
  entry('Validation and examples', '/ontology/validation-and-examples', 'SHACL shapes, overlay profiles and diagnostic exemplars for the PDTF 1.0-derived ontology', ['PDTF', 'SHACL'], true),
  entry('Trust, governance and limitations', '/ontology/trust-and-governance', 'Claims, evidence, governance, PII and known limitations of the draft derived ontology', ['PDTF', 'ontology governance'], true),
  entry('Use and tooling', '/ontology/use-and-tooling', 'Namespaces, consumption guidance and tool compatibility evidence', ['PDTF', 'ontology tools'], true),
