...
export const STANDARDS_PROFILE = Object.freeze([
  ...
  item('SSSOM', 'Version not selected; selection is a precondition to use', 'Mapping metadata, justification and confidence', 'No SSSOM conformance claimed', 'reference', 'Deferred candidate', 'Interoperability', 'PDTF schema adoption catalogue; ADR-0067', 'A cross-vocabulary mapping set is approved for authoring'),
