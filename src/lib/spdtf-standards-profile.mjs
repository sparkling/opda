...
const specification = (
  ...
  Object.freeze({ specificationMaturity, exactSnapshot, source, implementationStatus, implementationEvidence, candidateSnapshot, lastChecked: LAST_CHECKED })
);

const SPECIFICATION_EVIDENCE = Object.freeze({
  'SPDTF context-owned terms': specification('Internal governance decision', 'ADR-0074 · 2026-08-20', 'https://opda.org.uk/modelling/adr/adr-0074', 'not yet minted', 'Namespace and identifier governance remains unresolved'),
  ...
  'SPARQL 1.2': specification('W3C Working Draft', '2026-08-20', 'https://www.w3.org/TR/sparql12-query/', 'used and tested in Property Pack 0.1', 'Four ASK competency queries exercise a portable basic graph-pattern subset', 'SPARQL Query Working Draft · 2026-06-05'),
  'SHACL 1.2 Core': specification('W3C Working Draft', '2026-08-03', 'https://www.w3.org/TR/shacl12-core/', 'used and tested in Property Pack 0.1', 'Node/property shapes exercise a declared Core subset; no Union, AF or SPARQL claim', 'SHACL Core Working Draft · 2026-05-16'),
  ...
  'Dublin Core Terms': specification('DCMI Recommendation', '2020-01-20', 'https://www.dublincore.org/specifications/dublin-core/dcmi-terms/', 'used in Property Pack 0.1', 'dcterms:description and dcterms:source are emitted'),
  ...
  'OWL-Time': specification('W3C Recommendation', '2017-10-19', 'https://www.w3.org/TR/2017/REC-owl-time-20171019/', 'not used', 'No OWL-Time term occurs in Property Pack 0.1'),
  'Data Privacy Vocabulary 2.0': specification('Final Community Group Report — not a W3C Standard', '2.0 · 2024-08-01', 'https://w3id.org/dpv/2.0', 'not used', 'No DPV term occurs in Property Pack 0.1'),
  'DPV Personal Data 2.0': specification('Final Community Group Report — not a W3C Standard', '2.0 · 2024-08-01', 'https://w3id.org/dpv/2.0/pd', 'not used', 'No DPV-PD term occurs in Property Pack 0.1'),
  'DPV Legal 2.0': specification('Final Community Group Report — not a W3C Standard', '2.0 · 2024-08-01', 'https://w3id.org/dpv/2.0/legal', 'not used', 'No DPV-LEGAL term occurs in Property Pack 0.1'),
  ...
  UFO: specification('Design-time analytical framework', 'edition not selected', 'https://nemo-ufes.github.io/gufo/', 'not used or imported', 'PDTF 1.0 precedent only; no SPDTF 2.0 selection'),
  ...
  OntoClean: specification('Design-quality method', 'method profile not selected', 'https://www.loa.istc.cnr.it/old/Papers/GuarinoWeltyEKAW2000.pdf', 'not used as a runtime dependency', 'PDTF 1.0 precedent only; no SPDTF 2.0 selection'),
...
export const STANDARDS_PROFILE = Object.freeze([
  ...
  item('RDFS 1.2', 'RDF Schema 1.2 vocabulary used within the RDF 1.2 target', 'Labels and documentary class/property hierarchies', 'No inference beyond the declared tested regime', 'reference', 'Candidate feature boundary', 'Interoperability', 'ADR-0067 and candidate validation receipt', 'A competency question requires additional entailment'),
  item('OWL 2', 'W3C Recommendation, 11 December 2012', 'Context-owned classes, properties and ontology metadata', 'Only features named and tested by a package release', 'reference', 'Accepted bounded target', 'Interoperability with each domain owner', 'ADR-0067 §5.4', 'A required construct falls outside the tested profile'),
  ...
  item('SPARQL 1.2', 'Portable SPARQL 1.2 subset; feature manifest required per package', 'Competency and conformance queries', 'Only features passing all declared engines', 'reference', 'Accepted target with subset unresolved until first package', 'Validation maintainers', 'ADR-0067 §5.4; package feature receipt', 'A query requires a feature outside the portable subset'),
  item('SHACL 1.2 Core', 'SHACL 1.2 Core target named by ADR-0067', 'Fail-closed structural and business-rule validation', 'Core initially; AF or SPARQL features require separate receipts', 'reference', 'Accepted bounded target', 'Validation maintainers and domain owner', 'ADR-0067 §5.4; package validation receipt', 'A confirmed rule cannot be expressed in the Core subset'),
