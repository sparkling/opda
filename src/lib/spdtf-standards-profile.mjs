...
const SPECIFICATION_EVIDENCE = Object.freeze({
  ...
  SKOS: specification('W3C Recommendation', '2009-08-18', 'https://www.w3.org/TR/skos-reference/', 'used in Property Pack 0.1', 'Concept schemes, concepts, labels, definitions, notations and inScheme are emitted; hierarchy and mapping predicates are absent'),
  ...
  SSSOM: specification('Community specification', '1.0', 'https://mapping-commons.github.io/sssom/1.0/', 'not used', 'Cross-context mapping set is empty; no SSSOM or SEMAPV artefact, profile or conformance receipt exists'),
  ...
  UFO: specification('Design-time analytical framework', 'edition not selected', 'https://doi.org/10.3233/AO-150157', 'not used or imported', 'PDTF schema precedent only; no SPDTF selection'),
  ...
  OntoClean: specification('Design-quality method', 'method profile not selected', 'https://doi.org/10.1145/503124.503150', 'not used as a runtime dependency', 'PDTF schema precedent only; no SPDTF selection'),
  DOLCE: specification('Foundational ontology', 'edition not selected', 'https://www.loa.istc.cnr.it/dolce/overview.html', 'not used or imported', 'PDTF schema comparison only; no SPDTF disposition'),
});
...
export const STANDARDS_PROFILE = Object.freeze([
  ...
  item('SKOS', 'W3C Recommendation, 18 August 2009', 'Controlled vocabularies, taxonomies and mapping relations between SKOS concepts', 'Plain SKOS; mapping predicates require concept endpoints and SKOS-XL is not selected', 'reuse', 'Accepted bounded target', 'Vocabulary owner with Interoperability', 'ADR-0063/0067', 'Label modelling requires a separately governed lexical model'),
  ...
  item('Dublin Core Terms', 'DCMI Terms namespace; version 2020-01-20', 'Source, title, dates and administrative metadata', 'Reuse only the terms named by the package profile', 'reuse', 'Candidate by concern', 'Provenance owner', 'ADR-0067; PDTF schema adoption catalogue', 'A required metadata meaning is absent or mismatched'),
  item('DCAT 3', 'W3C Recommendation, 22 August 2024', 'Dataset and distribution catalogue metadata', 'No catalogue conformance claimed until a publishing use case exists', 'reference', 'Conditional candidate', 'Resources and Governance', 'PDTF schema adoption catalogue; ADR-0067', 'A governed dataset catalogue or external registration is required'),
  item('PROV-O', 'W3C Recommendation, 30 April 2013', 'Attribution, derivation, activity and agent provenance', 'Concern-specific reuse; no complete PROV profile claimed', 'reuse', 'Candidate by concern', 'Provenance owner', 'ADR-0067; PDTF schema evidence', 'A provenance competency question cannot be answered'),
  ...
  item('Data Privacy Vocabulary 2.0', 'DPV 2.0 final specification, 1 August 2024', 'Purpose, processing and privacy semantics', 'Semantic description only; no runtime authorisation claim', 'reference', 'Candidate by concern', 'DBT Smart Data group with Governance', 'ADR-0067; PDTF schema adoption catalogue', 'Legal or participant review selects a bounded DPV profile'),
  item('DPV Personal Data 2.0', 'DPV-PD 2.0 final specification, 1 August 2024', 'Personal-data categories', 'Reference only until reviewed categories are recorded', 'reference', 'Candidate by concern', 'DBT Smart Data group with Governance', 'ADR-0067; PDTF schema adoption catalogue', 'A reviewed sensitivity question selects a category'),
  item('DPV Legal 2.0', 'DPV-LEGAL 2.0 final specification, 1 August 2024', 'Jurisdictional legal concepts', 'No legal conclusion or statutory authority implied', 'reference', 'Conditional/deferred candidate', 'Governance with legal review', 'ADR-0067; PDTF schema adoption catalogue', 'Legal review identifies an exact applicable profile'),
  item('ODRL 2.2', 'W3C Recommendation, 15 February 2018', 'Policy, permission and prohibition semantics', 'Reference only; no policy instances or enforcement claim', 'reference', 'Conditional/deferred candidate', 'DBT Smart Data group with Governance', 'ADR-0067; PDTF schema adoption catalogue', 'A reviewed policy-authoring use case is accepted'),
  item('SSSOM', 'SSSOM and its paired SEMAPV justification dependency have no selected versions; selection is a precondition to use', 'Candidate exchange record for mapping sources, predicate, SEMAPV justification, authorship, review and confidence', 'No SSSOM or SEMAPV profile, artefact or conformance claimed; not selected for internal cross-context records', 'reference', 'Deferred candidate', 'Interoperability', 'ODR-0002 deferral; ADR-0063/0067 completeness concern', 'A named external-vocabulary mapping, named consumer and recorded Council re-evaluation select a scoped profile; internal mappings are included only if that decision explicitly says so'),
  item('FIBO', 'Version not selected; selection is a precondition to use', 'Comparison with finance-domain meanings', 'No import or conformance', 'reference', 'Reference candidate only', 'Finance and Banking', 'PDTF schema rejection register', 'A finance competency question would otherwise reinvent a FIBO concept'),
  item('GeoSPARQL', 'Version not selected; selection is a precondition to use', 'Geometry and spatial-query semantics', 'No reuse or conformance', 'reference', 'Conditional/deferred candidate', 'Property Data Services', 'PDTF schema rejection register', 'Title extents, search polygons or radius queries enter scope'),
  item('Schema.org', 'Version not selected; selection is a precondition to use', 'Possible publication mapping for open-web consumers', 'Publication mapping only; never ontology authority', 'map', 'Deferred candidate', 'Property Technology with Interoperability', 'PDTF schema rejection register', 'A concrete open-web publication use case is approved'),
  item('W3C Verifiable Credentials Data Model 2.0', 'W3C Recommendation, 15 May 2025', 'Portable credential presentation and verification semantics', 'Reference only; no wallet or trust-scheme conformance', 'reference', 'Deferred candidate', 'DBT Smart Data group', 'PDTF schema adoption catalogue', 'A real wallet or credential consumer enters scope'),
  item('W3C DID Core 1.0', 'W3C Recommendation, 19 July 2022', 'Decentralised identifier resolution reference', 'No DID method selected and no resolution claim', 'reference', 'Deferred candidate', 'DBT Smart Data group', 'PDTF schema adoption catalogue', 'A governed credential ecosystem requires DID resolution'),
  item('W3C Organization Ontology', 'W3C Recommendation, 16 January 2014', 'Organisational structures and roles', 'Reference candidate; exact reused terms must be declared', 'reference', 'Candidate by concern', 'Relevant domain owner', 'PDTF schema evidence; ADR-0067', 'A participant or organisation competency question selects terms'),
  ...
  item('UFO', 'No edition selected; design-time analytical framework only', 'Identity, roles, relators and category distinctions', 'No import, runtime dependency or conformance claim', 'reference', 'method candidate — not adopted', 'Ontology facilitators with domain review', 'PDTF schema methodology evidence; ADR-0074 non-inheritance rule', 'A governance decision selects a bounded analytical profile'),
  item('gUFO', 'Version 1.0.0 is available; no term-level profile selected', 'Possible OWL implementation of selected UFO distinctions', 'Deferred; no import or term reuse', 'reference', 'deferred — not adopted', 'Ontology facilitators with Interoperability', 'PDTF schema annotation precedent only', 'A selected UFO method requires reviewed reusable terms'),
  item('OntoClean', 'No method profile selected', 'Rigidity, identity and valid subsumption checks', 'Design-quality method only; no runtime dependency', 'reference', 'method candidate — not adopted', 'Ontology facilitators with domain review', 'PDTF schema methodology evidence; ADR-0074 non-inheritance rule', 'A governance decision selects a bounded quality method'),
  item('DOLCE', 'No edition selected', 'Historical comparison for foundational distinctions', 'No SPDTF disposition, import or conformance claim', 'reference', 'historical PDTF schema reference only', 'Ontology facilitators', 'PDTF schema methodology evidence', 'A new competency question justifies a separately reviewed comparison'),
]);
