 ...
 *   concept/logical  → /spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/<tier>/<module>/<localName-lowercase>
 *   physical-ontology → /spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/physical-ontology/<module>/classes#<localName>
 *   physical-database → /spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/physical-database/modules/<module>#<localName>
 *
...
export function buildCrossTierUrls(
  ...
  return {
    concept: has('concept')
      ? `/spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/concept/${module}/${slug}`
      : null,
    logical: has('logical')
      ? `/spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/logical/${module}/${slug}`
      : null,
    physicalDatabase: has('physical-database')
      ? `/spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/physical-database/modules/${module}#${localName}`
      : null,
    physicalOntology: has('physical-ontology')
      ? `/spdtf/inputs/pdtf-schema/schema-derived-ontology/model-views-by-audience/physical-ontology/${module}/classes#${localName}`
      : null,
  };
}
